                    ...
                    <div class="post">
                        <div class="row">
                            <div class="text col-md-6">
                                ...
                                <div class="name">
                                    <h1><font size="4">名前</font></h1>{{ str_limit($post->name, 150) }}
                                </div>
                                
                                <div class="hobby mt-3">
                                  
                                    <h1><font size="4">趣味</font></h1>{{ str_limit($post->hobby, 1500) }}
                                </div>
                            
                            
                            <div class="introduction mt-3">
                               <h1><font size="4">自己紹介</font></h1> {{ str_limit($post->introduction, 1500) }}
                            </div>
                           </div>
                        </div>
                    </div>
